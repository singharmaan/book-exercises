...
# This layout will contain the following elements:
  ...
  # text.
  p(
    "The graph shows how the 1% rich saw incomes jump", strong("6%"), "since 1980", "while the bottom", strong("60%"),
    "have seen little increase", em("(stagnated income)")
  ),
  p('Click on the "chart" tab to see a diagram')
  )
